...
for(const [ name, factory ] of new Map<string, Function>([ [ '@angular/core', createAngularInjector ], [ 'injection-js', createInjectionJsInjector ] ])) {
    describe(name, () => {
        beforeEach(() => {
        ...
        describe('Relations', () => {
            ...
            it('should write and read entity with relations', async () => {
                ...
                expect(e.hasMany).to.be.an('array').with.length(2);
                ...
                expect(e.hasManyMap).to.be.an('object').with.keys('b', 'c');
            ...
            it('should write and read entity with circular relations', async () => {
                ...
                expect(res[ 0 ].joins).to.be.an('array').with.length(2);
